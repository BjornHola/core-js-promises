...
getPromiseResult(Promise.resolve()).then((result) => result);
getPromiseResult(Promise.reject()).then((result) => result);
/**
...
getAllOrNothing([Promise.resolve(1), Promise.resolve(2), Promise.resolve(3)])
  .then((result) => result)
  .catch((error) => error);
